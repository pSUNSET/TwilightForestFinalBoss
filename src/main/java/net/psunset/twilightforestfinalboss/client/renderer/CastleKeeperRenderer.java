...
public class CastleKeeperRenderer extends GeoEntityRenderer<CastleKeeper> {
    ...
    @Override
    public void preRender(PoseStack poseStack, CastleKeeper animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        float scale = 1.0F;

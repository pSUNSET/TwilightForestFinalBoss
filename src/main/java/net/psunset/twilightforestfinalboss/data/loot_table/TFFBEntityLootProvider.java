        ...
        add(TFFBEntities.CASTLE_KEEPER.get(), LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.ENDER_PEARL)
                                ...
                                .apply(LimitCount.limitCount(IntRange.upperBound(16)))))
                .withPool(LootPool.lootPool()
                        .name("lich_crown")
                        .setRolls(ConstantValue.exactly(1.0F))
                ...
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(TFItems.DIAMOND_MINOTAUR_AXE.get())
                                .apply(MultiplayerBasedAdditionLootFunction.addForAllParticipatingPlayers(ConstantValue.exactly(0.33f)))))
                .withPool(LootPool.lootPool()
                        .name("hydra_chop")
                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(TFItems.HYDRA_CHOP.get())
                                ...
                                .apply(LimitCount.limitCount(IntRange.upperBound(32)))))
                .withPool(LootPool.lootPool()
                        .name("hydra_blood")
                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
                ...
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(TFItems.CUBE_TALISMAN.get())
                                ...
                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0.0F, 0.1F)))
                                .apply(MultiplayerBasedAdditionLootFunction.addForAllParticipatingPlayers(UniformGenerator.between(0.0F, 0.8F)))))
                .withPool(LootPool.lootPool()
                        .name("incomplete_thorncutter_axe")
                        .setRolls(ConstantValue.exactly(1.0F))
                        .add(OptionalLootItem.optionalItem(RLUtl.ofTFLostBlocks("incomplete_thorncutter_axe"))
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))));
    }
